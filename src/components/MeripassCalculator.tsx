...
const TheoryView = () => (
  <div className="p-6 bg-white rounded-xl shadow-sm border border-slate-100 animate-in fade-in duration-500">
    ...
    <div className="space-y-4 text-slate-600 text-sm">
      ...
      <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 my-4 font-mono text-xs md:text-sm overflow-x-auto">
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-gray-50 text-slate-800 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
        ...
        {/* 右パネル: 計算結果シート (Guide/Theoryの時は隠す、または表示したままにするかは要件次第ですが、今回はメイン計算機の時のみ表示されるようにします) */}
        {currentView === 'calculator' && (
