<script lang="ts">
  ...
  import { greatCircleSailing } from '$lib/utils/greatCircle';
...
<div class="space-y-8 pb-20">
  <header>
    <h2 class="text-2xl font-bold text-slate-800 dark:text-white border-l-4 border-blue-600 pl-3">大圏航法</h2>
    <p class="text-xs text-slate-400 mt-1 pl-4">2地点間の大圏距離と初針路を計算します</p>
  </header>
